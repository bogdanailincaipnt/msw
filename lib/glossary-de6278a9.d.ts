...
import {
  RequestInit as RequestInit$1,
  IsomorphicRequest,
  IsomorphicResponse,
} from '@mswjs/interceptors'
import { FlatHeadersObject, Headers } from 'headers-polyfill'

type HeadersObject<KeyType extends string = string> = Record<
  KeyType,
  string | string[]
>
/**
...
type ForbiddenHeaderError<HeaderName extends string> =
 ...
 */
declare function set<N extends string | HeadersObject>(
...
type LifeCycleEventEmitter<ResponseType extends Record<string | symbol, any>> =
...
type MaybeAsyncResponseResolverReturnType<ReturnType> = MaybePromise<
  ResponseResolverReturnType<ReturnType>
>
type AsyncResponseResolverReturnType<ReturnType> =
...
declare abstract class RequestHandler<
...
type ResponseComposition<BodyType extends DefaultBodyType = any> =
...
declare function createResponseComposition<BodyType extends DefaultBodyType>(
...
export {
  AsyncResponseResolverReturnType as A,
  DelayMode as B,
  RequestCache as C,
  DefaultContext as D,
  RequestMode as E,
  RequestRedirect as F,
  RequestDestination as G,
  RequestPriority as H,
  RequestReferrerPolicy as I,
  MockedRequestInit as J,
  SetupServer as K,
  LifeCycleEventsMap as L,
  MockedRequest as M,
  ResponseTransformer as R,
  SetupApi as S,
  WorkerLifecycleEventsMap as W,
  set as a,
  SetupWorker as b,
  RequestHandler as c,
  delay as d,
  StartOptions as e,
  fetch as f,
  StartReturnType as g,
  DefaultBodyType as h,
  ResponseResolver as i,
  ResponseResolutionContext as j,
  SerializedResponse as k,
  RequestHandlerDefaultInfo as l,
  MockedResponse as m,
  ResponseLookupResult as n,
  SharedOptions as o,
  ServerLifecycleEventsMap as p,
  defaultResponse as q,
  response as r,
  status as s,
  createResponseComposition as t,
  defaultContext as u,
  ResponseResolverReturnType as v,
  DefaultRequestMultipartBody as w,
  ResponseComposition as x,
  ResponseCompositionOptions as y,
  ResponseFunction as z,
}
