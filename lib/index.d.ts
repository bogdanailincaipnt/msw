import {
  R as ResponseTransformer,
  s as status,
  a as set,
  d as delay,
  f as fetch,
  S as SetupApi,
  W as WorkerLifecycleEventsMap,
  b as SetupWorker,
  c as RequestHandler,
  e as StartOptions,
  g as StartReturnType,
  D as DefaultContext,
  h as DefaultBodyType,
  M as MockedRequest,
  i as ResponseResolver,
  j as ResponseResolutionContext,
  k as SerializedResponse,
  l as RequestHandlerDefaultInfo,
  m as MockedResponse,
  n as ResponseLookupResult,
  o as SharedOptions,
  p as ServerLifecycleEventsMap,
} from './glossary-de6278a9.js'
export {
  A as AsyncResponseResolverReturnType,
  h as DefaultBodyType,
  w as DefaultRequestMultipartBody,
  B as DelayMode,
  M as MockedRequest,
  J as MockedRequestInit,
  m as MockedResponse,
  C as RequestCache,
  G as RequestDestination,
  c as RequestHandler,
  E as RequestMode,
  H as RequestPriority,
  F as RequestRedirect,
  I as RequestReferrerPolicy,
  x as ResponseComposition,
  y as ResponseCompositionOptions,
  z as ResponseFunction,
  i as ResponseResolver,
  v as ResponseResolverReturnType,
  R as ResponseTransformer,
  S as SetupApi,
  b as SetupWorker,
  o as SharedOptions,
  e as StartOptions,
  t as createResponseComposition,
  u as defaultContext,
  q as defaultResponse,
  r as response,
} from './glossary-de6278a9.js'
...
> = Type extends Fn
  ...
  : Type
type GraphQLPayloadContext<QueryType extends Record<string, unknown>> = (
  payload: QueryType,
) => ResponseTransformer
 ...
 */
declare const json: <BodyTypeJSON>(
  body: BodyTypeJSON,
 ...
 */
declare const text: <BodyType extends string>(
  body: BodyType,
) => ResponseTransformer<BodyType>
 ...
 */
declare const xml: <BodyType extends string>(
  body: BodyType,
) => ResponseTransformer<BodyType>
...
declare const rest: {
  ...
  head: <
    ...
    Params_1 extends PathParams<keyof Params_1> = PathParams,
    ResponseBody_1 extends DefaultBodyType = DefaultBodyType,
  >(
    path: Path,
    resolver: ResponseResolver<
      RestRequest<never, Params_1>,
      RestContext,
      ResponseBody_1
    >,
  ) => RestHandler<MockedRequest<DefaultBodyType>>
  get: <
    ...
    Params_2 extends PathParams<keyof Params_2> = PathParams,
  ...
  post: <
    ...
    Params_3 extends PathParams<keyof Params_3> = PathParams,
    ResponseBody_3 extends DefaultBodyType = DefaultBodyType,
  >(
    path: Path,
    resolver: ResponseResolver<
      RestRequest<RequestBodyType_3, Params_3>,
      RestContext,
      ResponseBody_3
    >,
  ) => RestHandler<MockedRequest<DefaultBodyType>>
  put: <
    ...
    Params_4 extends PathParams<keyof Params_4> = PathParams,
    ResponseBody_4 extends DefaultBodyType = DefaultBodyType,
  >(
    path: Path,
    resolver: ResponseResolver<
      RestRequest<RequestBodyType_4, Params_4>,
      RestContext,
      ResponseBody_4
    >,
  ) => RestHandler<MockedRequest<DefaultBodyType>>
  delete: <
    ...
    Params_5 extends PathParams<keyof Params_5> = PathParams,
    ResponseBody_5 extends DefaultBodyType = DefaultBodyType,
  >(
    path: Path,
    resolver: ResponseResolver<
      RestRequest<RequestBodyType_5, Params_5>,
      RestContext,
      ResponseBody_5
    >,
  ) => RestHandler<MockedRequest<DefaultBodyType>>
  patch: <
    ...
    Params_6 extends PathParams<keyof Params_6> = PathParams,
    ResponseBody_6 extends DefaultBodyType = DefaultBodyType,
  >(
    path: Path,
    resolver: ResponseResolver<
      RestRequest<RequestBodyType_6, Params_6>,
      RestContext,
      ResponseBody_6
    >,
  ) => RestHandler<MockedRequest<DefaultBodyType>>
  options: <
    ...
    Params_7 extends PathParams<keyof Params_7> = PathParams,
    ResponseBody_7 extends DefaultBodyType = DefaultBodyType,
  >(
    path: Path,
    resolver: ResponseResolver<
      RestRequest<RequestBodyType_7, Params_7>,
      RestContext,
      ResponseBody_7
    >,
  ) => RestHandler<MockedRequest<DefaultBodyType>>
 ...
 */
declare const field: <FieldNameType extends string, FieldValueType>(
...
type GraphQLContext<QueryType extends Record<string, unknown>> =
  DefaultContext & {
...
declare const standardGraphQLHandlers: {
  ...
  >(
    ...
    >,
  ) => GraphQLHandler<GraphQLRequest<Variables>>
  /**
  ...
  >(
    operationName:
      ...
      | TypedDocumentNode<Query_1, Variables_1>,
    resolver: ResponseResolver<
      GraphQLRequest<Variables_1>,
      GraphQLContext<Query_1>
    >,
  ) => GraphQLHandler<GraphQLRequest<Variables_1>>
  /**
